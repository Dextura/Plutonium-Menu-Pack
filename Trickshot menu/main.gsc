...
*	 Project : Trickshotmenu
*    Mode : Multiplayer
*	 Date : 2021/06/28 - 16:08:35	
*
*/	



// Below is This type of preprocessor directive tells the compiler to include a file in the source code program
...
// the welcome message when person joins and loads in a game
welcome_message(){
	self endon("disconnect");																										//kill on disconnect.
	self endon("death");																											//kill on death.
	level endon("game_ended");  																									//kill on game end.
	self thread large_message("^5Welcome " + self.name, "^5 To the James-T6 Trickshotting server!", "em_bg_flag_netherlands", 10);	//Enlarged message.
